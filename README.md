Conversor de Velocidades con Búsqueda Binaria
...
El desarrollo de este proyecto forma parte de mi crecimiento como desarrollador backend aplicando mis conocimientos aprendidos en la UTN(Universidad Tecnologica Nacional) en la materia de Algoritmos y estructuras de datos poniendo especial énfasis en la eficiencia algorítmica. Utilicé un algoritmo de búsqueda binaria para asegurar que la consulta de registros históricos sea rápida, independientemente del volumen de datos almacenados.
También me enfoqué en el manejo de persistencia de archivos mediante el formato CSV, asegurando que la información se guarde de forma estructurada y sea fácilmente recuperable para futuras sesiones de uso.
